...
Start here: /docs/START_HERE_FOR_AGENTS.md
...
Local app rule: install the approved fonts on the machine first. GitHub does not install fonts for you.

Do not invent new styles. Copy from the component library and extend carefully.
